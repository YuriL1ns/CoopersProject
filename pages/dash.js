...
export default function Index() {
    return (
        <>
                    ...
                    <div className='md:w-6/12 px-2 md:pr-4'>
                        ...
                        <div className='w-full mt-[20px] md:mt-[44px]'>
                            <Link
                                ...
                                duration={1200}
                            >
                                <button className='w-8/12 md:w-[300px] flex justify-center text-white font-semibold px-2 md:px-4 py-2 md:py-4 rounded-xl outline-none focus:outline-none bg-[#4AC959] hover:bg-black active:bg-black md:text-2xl shadow hover:shadow-lg ease-linear transition-all duration-150'>
                                    Go to To-do list
                                </button>
                            </Link>
                        </div>
                        <img
                            className='absolute z-20 top-[15%] md:top-[20%] right-30 bottom-30 left-[60%] md:left-[65%] w-4/12 md:w-3/12'
                            src='img/02.png'
                            alt='Coworking'
                        />
                    </div>
                ...
                <div className='container mx-auto justify-center items-center text-center'>
                    <div className='relative flex flex-col'>
                        <div className='px-4 py-5 flex-auto items-center'>
                            <h6 className='pt-20 md:pt-52 text-4xl md:text-7xl mb-1 font-semibold text-white font-poppins'>
                                To-do List
                            </h6>
                            <img
                                src='img/Path.png'
            ...
            <section className='container text-center mx-auto w-full'>
                <div>
            ...
            <section>
                <div className='container mx-auto px-4 pb-32 pt-48'>
                    <div className='items-center flex flex-wrap justify-center'>
                        <div className='block px-6 rounded-lg drop-shadow-xl bg-white md:max-w-md w-full'>
